...
{ Copyright (c) 2016 by Albert Molina
  ...
  Modified by PBM:
  Added TStreamOp From UAccounts.pas also copyright (c) 2016 by Albert Molina}

{.$I config.inc}
{.$DEFINE OpenSSL10} //* added
interface

uses
  Classes, SysUtils, UOpenSSL, UOpenDef;
...
Type
  ...
  {From UAccounts.pas Copyright (c) 2016 by Albert Molina}
